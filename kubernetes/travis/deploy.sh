...
openssl aes-256-cbc -K $encrypted_c64fb6df7a35_key -iv $encrypted_c64fb6df7a35_iv -in ./kubernetes/travis/susi-telegrambot-e467bca1e540.json.enc -out susi-telegrambot-e467bca1e540.json -d
mkdir -p lib
